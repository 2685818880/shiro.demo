...
@Service
public class PermissionServiceImpl extends BaseMybatisDao<UPermissionMapper>
	...
	public Map<String, Object> deletePermissionById(String ids) {
		...
		try {
			...
			for (String idx : idArray) {
				...
				List<URolePermission> rolePermissions = rolePermissionMapper
						.findRolePermissionByPid(id);
	...
	@Override
	public Pagination<UPermission> findPage(Map<String, Object> resultMap,
			...
			if (StringUtils.isNotBlank(ids)) {
				...
				for (String pid : idArray) {
					...
					if (StringUtils.isNotBlank(pid)) {
						URolePermission entity = new URolePermission(roleId,
								new Long(pid));
